...
if [[ -n "$CONFIG_SRC" ]]; then
  ...
  sed -i 's/version:[[:space:]]*"[^"]*"/version: "0.3.1"/' "$ROOT/config.js"
...
echo
echo "IMPORTANT:"
echo "1) Run supabase_upgrade_0.3.1.sql in the PROD Supabase SQL Editor."
...
echo "Deploy:"
echo "  git add -A"
echo '  git commit -m "StudyNurse v0.3.1"'
echo "  git push"
